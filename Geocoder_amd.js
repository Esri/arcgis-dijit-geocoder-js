require([
    ...
    declare("esri.dijit.Geocoder", [_WidgetBase, _OnDijitClickMixin, _TemplatedMixin], {
        ...
        _insertGeocoderMenuItems: function () {
            if (this._geocoder.length > 1 && this.geocoderMenu) {
				var html = '';
        ...
        _inputKeyUp: function (event) {
            if (event) {
                ...
                if (event.keyCode === this._tabKey || event.keyCode === this._shiftKey || event.keyCode === this._upArrow || event.keyCode === this._downArrow || event.keyCode === this._leftArrow || event.keyCode === this._rightArrow) {
                    return;
